            ...
            header={
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <Link
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/60 rounded-lg transition shrink-0"
                    >
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/80 dark:border-slate-800 p-5 sm:p-6 flex flex-col md:flex-row md:items-center justify-between gap-5">
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                            <div className="rounded-lg border border-slate-200/80 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/40 p-3 text-center min-w-[95px]">
                    ...
                    <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-1 p-1 bg-white dark:bg-slate-900 rounded-xl border border-slate-200/80 dark:border-slate-800 overflow-x-auto">
                            ...
                            >
                                <span>All Tasks</span>
                                <span className={`text-[10px] px-1.5 py-0.2 rounded font-mono ${activeTab === 'all' ? 'bg-indigo-700 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-500'}`}>
                                    {assignments.length}
                                </span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className={`text-[10px] px-1.5 py-0.2 rounded font-mono ${activeTab === 'pending' ? 'bg-indigo-700 text-white' : 'bg-amber-50 dark:bg-amber-950 text-amber-600'}`}>
                                    {stats.pending || 0}
                                </span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className={`text-[10px] px-1.5 py-0.2 rounded font-mono ${activeTab === 'review' ? 'bg-indigo-700 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-500'}`}>
                            ...
                            >
                                <span>Evaluated</span>
                                <span className={`text-[10px] px-1.5 py-0.2 rounded font-mono ${activeTab === 'graded' ? 'bg-indigo-700 text-white' : 'bg-emerald-50 dark:bg-emerald-950 text-emerald-600'}`}>
                                    {stats.graded || 0}
                                </span>
                            </button>
                        </div>
                                    ...
                                    <div className="space-y-3.5">
                                        ...
                                        <div className="flex items-center justify-between gap-2">
                                            ...
                                            {item.status === 'submitted' && (
                                                <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800">
                                            ...
                                            {item.status === 'pending' && (
                                                <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-800">
                                                    Pending Submission
                                                </span>
                                            )}
                                        ...
                                        {/* Specs Grid */}
                                        <div className="grid grid-cols-3 gap-2 p-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 text-center text-xs font-mono">
                                            <div>
