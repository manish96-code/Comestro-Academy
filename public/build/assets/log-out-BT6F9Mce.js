...
to {
  ...
  animation: ${J} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,ae=({toast:e})=>{let{icon:t,type:n,iconTheme:i}=e;return t===void 0?n===`blank`?null:r.createElement(ie,null,r.createElement(U,{...i}),n!==`loading`&&r.createElement(q,null,n===`error`?r.createElement(V,{...i}):r.createElement(K,{...i}))):typeof t==`string`?r.createElement(Y,null,t):t},oe=e=>`
0% {transform: translate3d(0,${e*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,se=e=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${e*-150}%,-1px) scale(.6); opacity:0;}
`,ce=`0%{opacity:0;} 100%{opacity:1;}`,le=`0%{opacity:1;} 100%{opacity:0;}`,ue=b(`div`)`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`,fe=(e,t)=>{let n=e.includes(`top`)?1:-1,[r,i]=C()?[ce,le]:[oe(n),se(n)];return{animation:t?`${v(r)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${v(i)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},pe=r.memo(({toast:e,position:t,style:n,children:i})=>{let a=e.height?fe(e.position||t||`top-center`,e.visible):{opacity:0},o=r.createElement(ae,{toast:e}),s=r.createElement(de,{...e.ariaProps},x(e.message,e));return r.createElement(ue,{className:e.className,style:{...a,...n,...e.style}},typeof i==`function`?i({icon:o,message:s}):r.createElement(r.Fragment,null,o,s))});y(r.createElement);var me=({id:e,className:t,style:n,onHeightUpdate:i,children:a})=>{let o=r.useCallback(t=>{if(t){let n=()=>{let n=t.getBoundingClientRect().height;i(e,n)};n(),new MutationObserver(n).observe(t,{subtree:!0,childList:!0,characterData:!0})}},[e,i]);return r.createElement(`div`,{ref:o,className:t,style:n},a)},he=(e,t)=>{let n=e.includes(`top`),r=n?{top:0}:{bottom:0},i=e.includes(`center`)?{justifyContent:`center`}:e.includes(`right`)?{justifyContent:`flex-end`}:{};return{left:0,right:0,display:`flex`,position:`absolute`,transition:C()?void 0:`all 230ms cubic-bezier(.21,1.02,.73,1)`,transform:`translateY(${t*(n?1:-1)}px)`,...r,...i}},ge=m`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,X=16,_e=({reverseOrder:e,position:t=`top-center`,toastOptions:n,gutter:i,children:a,toasterId:o,containerStyle:s,containerClassName:c})=>{let{toasts:l,handlers:u}=L(n,o);return r.createElement(`div`,{"data-rht-toaster":o||``,style:{position:`fixed`,zIndex:9999,top:X,left:X,right:X,bottom:X,pointerEvents:`none`,...s},className:c,onMouseEnter:u.startPause,onMouseLeave:u.endPause},l.map(n=>{let o=n.position||t,s=he(o,u.calculateOffset(n,{reverseOrder:e,gutter:i,defaultPosition:t}));return r.createElement(me,{id:n.id,key:n.id,onHeightUpdate:u.updateHeight,className:n.visible?ge:``,style:s},n.type===`custom`?x(n.message,n):a?a(n):r.createElement(pe,{toast:n,position:o}))}))},Z={name:`layout-dashboard`,size:24,node:[[`rect`,{width:`7`,height:`9`,x:`3`,y:`3`,rx:`1`,key:`10lvy0`}],[`rect`,{width:`7`,height:`5`,x:`14`,y:`3`,rx:`1`,key:`16une8`}],[`rect`,{width:`7`,height:`9`,x:`14`,y:`12`,rx:`1`,key:`1hutg5`}],[`rect`,{width:`7`,height:`5`,x:`3`,y:`16`,rx:`1`,key:`ldoo1y`}]]};Z.node;var Q=n(Z),$={name:`log-out`,size:24,node:[[`path`,{d:`m16 17 5-5-5-5`,key:`1bji2h`}],[`path`,{d:`M21 12H9`,key:`dn1m92`}],[`path`,{d:`M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4`,key:`1uf3rs`}]]};$.node;var ve=n($);export{F as i,Q as n,_e as r,ve as t};